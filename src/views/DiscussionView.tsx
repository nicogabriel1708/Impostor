				...
				{!me?.isSpectator && (
					<div className="absolute right-4 bottom-full mb-4 z-20">
						<button
							...
							className={cn(
								"px-4 py-3 rounded-3xl flex items-center space-x-2 text-xs font-black uppercase tracking-widest transition-transform active:translate-y-1 shadow-2xl border-b-4",
