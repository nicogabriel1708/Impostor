    ...
    <div className="flex-1 flex flex-col items-center justify-center p-6 space-y-12">
      ...
      >
        ...
        <div className="text-center">
          <h1 className="text-5xl font-black tracking-tighter uppercase italic text-white mb-2">Impostor</h1>
          <p className="text-indigo-200 font-bold uppercase tracking-widest text-sm">Find the spy. Or blend in.</p>
        </div>
      </motion.div>
      ...
      {error && (
        <div className="bg-red-500/20 border-2 border-red-500 text-red-100 px-4 py-3 rounded-2xl w-full text-center text-sm font-bold shadow-lg">
          {error}
          <button onClick={clearError} className="ml-2 underline opacity-80 hover:opacity-100">Dismiss</button>
        </div>
      )}
      ...
      <div className="w-full space-y-6">
        <button
          onClick={createRoom}
          className="w-full bg-pink-500 hover:bg-pink-600 text-white font-bold py-5 px-6 rounded-3xl flex items-center justify-center space-x-2 transition-transform active:translate-y-1 shadow-xl border-b-4 border-pink-700 active:border-b-0 uppercase tracking-widest text-lg"
        >
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-indigo-600 text-indigo-300 font-bold uppercase tracking-widest">or join</span>
          </div>
        </div>
