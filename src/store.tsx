...
import { ClientRoomState, GameSettings, ChatMessage } from './types';
...
export const GameProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    ...
    newSocket.on('connect', () => {
      ...
      if (roomCodeRef.current && sessionIdRef.current) {
        newSocket.emit('rejoin_room', { roomCode: roomCodeRef.current, sessionId: sessionIdRef.current }, (res: any) => {
          if (res.success) {
  ...
  return (
    <GameContext.Provider value={{
      socket, roomState, sessionId, roomCode, chatMessages, isCreator,
      createRoom, joinRoom, leaveRoom, updatePlayer, updateSettings, startGame,
      submitClue, submitVote, nextRound, sendChatMessage,
